...
(function (Modernizr) {
  ...
  var STEP_PAGE_CLASS_REGEX = /(^|\s)step-\S+|page-\S+/g;
  var selectors = {
  ...
  function createSectionHeader(text) {
    return "<div class=\"section__header\">\n        <h2 class=\"section__title\">".concat(text, "</h2>\n      </div>");
  }
  /**
  ...
  function setBodyClasses() {
    ...
    if (S === undefined || S.Checkout === undefined || S.Checkout.step === undefined) {
      return;
    }
    ...
    $body.addClass("step-".concat(S.Checkout.step.replace('_', '-')));
    $body.addClass("page-".concat(S.Checkout.page.replace('_', '-')));
  }

  $document.on('page:load page:change', function () {
    // Replace sidebar images with bigger versions
    (0, _jquery.default)(selectors.productThumbnailImage).each(function (i, el) {
      var $img = (0, _jquery.default)(el);
      var $replaceImg = (0, _jquery.default)(document.createElement('img'));
      var ogSrc = $img.attr('src');
      var size = Image.imageSize(ogSrc); // For some reason, simply updating the src attribute wasn't working so I'm resorting to creating another image and swapping it in
...
},{"./core/image":3,"jquery":1}],3:[function(require,module,exports){
"use strict";
