(function () {
  ...
  let survey = {
    ...
    question: 'Was there anything that nearly stopped you from making a purchase today?', // question to ask
    desc: 'Please tell us, and include your email if you’d like a response.', // optional description
    textInputPlaceholder: 'Enter your answer here', // placeholder when type is 'text'
    textInputSubmit: 'Submit', // submit button text when type is 'text'
    ifttt: {
      event: 'AHM_Post Purchase Survey', // name of event to trigger from IFTTT
      key: 'bNzm0kTzinz_L5OGJZBdcn' // input your IFTTT Key
    },
  ...
  // Don't go below here if you don't know what you're doing

  let lines = [
    `<style>.btn-primary {flex:auto;min-width: -webkit-max-content;min-width: -moz-max-content;min-width: max-content;background-image: linear-gradient(to top, var(--tw-gradient-stops));padding-left: 1rem;padding-right: 1rem;padding-top: 0.5rem;padding-bottom: 0.5rem;--tw-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);}.btn-primary:hover {background-image: linear-gradient(to bottom, var(--tw-gradient-stops));--tw-shadow: inset 0 2px 4px 0 rgba(0, 0, 0, 0.06);box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);}.btn-primary:disabled {pointer-events: none;--tw-gradient-from: #525252;--tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to, rgba(82, 82, 82, 0));--tw-gradient-to: #737373;--tw-text-opacity: 1;color: rgba(249, 250, 251, var(--tw-text-opacity));}.btn-primary {--tw-gradient-from: #15803d;--tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to, rgba(21, 128, 61, 0));--tw-gradient-to: #16a34a;--tw-text-opacity: 1;color: rgba(249, 250, 251, var(--tw-text-opacity));}.btn-primary:hover {--tw-text-opacity: 1;color: rgba(255, 255, 255, var(--tw-text-opacity));}</style><h2 style="font-size:1.3rem;">${survey.question}</h2>`
  ];
  ...
  function showThanks(el) {
    ...
    Shopify.Checkout.OrderStatus.addContentBox(`<h2 style="font-size:1.3rem;">${survey.thankYou.title}</h2>`, survey.thankYou.message);
  }
